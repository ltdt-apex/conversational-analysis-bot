...
Usage:
    uv run python preprocess/prepare_data.py            # run all stages
    uv run python preprocess/prepare_data.py --stage ingest_raw
    uv run python preprocess/prepare_data.py --stage classify --limit 200
"""
...
# Allow running as a script: `python preprocess/prepare_data.py`
sys.path.insert(0, str(Path(__file__).resolve().parent.parent))

from backend.config import Config  # noqa: E402
from backend.db import connect, init_schema, transaction  # noqa: E402
from preprocess.text import clean_prefix  # noqa: E402
from preprocess import taxonomy as tax  # noqa: E402
...
def stage_classify(
    ...
    """
    from preprocess import classifier  # lazy — keeps anthropic out of import path otherwise
...
def stage_rollups(cfg: Config, *, force: bool = False, **_: object) -> None:
    from preprocess.rollups import run as _run_rollups
    _run_rollups(cfg, force=force)


def stage_embed(cfg: Config, *, force: bool = False, **_: object) -> None:
    from preprocess.embed import run as _run_embed
